...
<style>
    body {
        background: url('/public/img/_newsbg.jpg') no-repeat center 0;
    }
</style>
<body>
<div class="newscont newscont_fix">
    ...
    <div class="middle_silder">
        <div class="container" id="idTransformView2">
            <ul class="slider" id="idSlider2">
                ...
                <li><a href="#"><img src="img/silderbar.png"/>
    ...
    <div class="right_newslist">
        ...
        if ($news) {
            foreach ($news as $row) {
                echo '<a href="' . APP_URL . '/news/show?id=' . $row['id'] . '">' . $row['title'] . ' <span>' . date('Y-m-d', $row['inputtime']) . '</span></a>';
            }
        }
